return function()
  ...
  local icon = {
    cmp = require('plugin.util.icon').get('cmp', true),
    diagnostics = require('plugin.util.icon').get('diagnostics', true),
    kind = require('plugin.util.icon').get('kind', true),
    type = require('plugin.util.icon').get('type', true),
    ui = require('plugin.util.icon').get('ui', true),
  }
