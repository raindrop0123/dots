    ...
    highlight_overrides = {
      all = function(colors)
        return {
          ...
          PmenuSel = { fg = colors.crust, bg = colors.green, style = { 'bold' } },
          PmenuBorder = { fg = colors.text, bg = colors.crust, style = { 'bold' } },
          CmpItemAbbr = { fg = colors.text },
          CmpItemAbbrMatch = { fg = colors.text, style = { 'bold' } },
          CmpDoc = { fg = colors.text, bg = colors.mantle, style = { 'bold' } },
          CmpDocBorder = { fg = colors.text, bg = colors.crust, style = { 'bold' } },
        }
      end,
    },
  })
