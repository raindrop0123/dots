...
(add-hook 'after-init-hook
          #'(lambda ()
              ...
              (custom-set-faces '(line-number ((t (:background "#000000" :foreground "#666666")))))
              (custom-set-faces '(line-number-current-line ((t (:background "#000000")))))
              (custom-set-faces '(font-lock-comment-face ((t (:foreground "#666666")))))
              (custom-set-faces '(mode-line ((t (:background "#000000" :weight bold)))))))
